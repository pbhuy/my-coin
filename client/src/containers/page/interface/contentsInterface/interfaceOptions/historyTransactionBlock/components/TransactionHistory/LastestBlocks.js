        ...
        >
          <div className="flex space-x-2">
            ...
            <div className="text-sm">
              ...
              <div className="text-xs">{block.timestamp}</div>
            </div>
          </div>
          <div className="w-5 text-sm flex-1">
            ...
            <div className="text-blue-500 text-left">Transaction: <span className="text-gray-800">{block.transactions.length} Txs</span></div>
          </div>
